...
* **CORS is Not Authentication**: Cross-Origin Resource Sharing (CORS) is a browser mechanism for controlling cross-origin response reading. CORS headers alone do not authenticate callers or prevent non-browser HTTP requests.
